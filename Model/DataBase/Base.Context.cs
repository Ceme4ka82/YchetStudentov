...
namespace YchetStudentov.Model.DataBase
{
    ...
    public partial class StudYchetEntities : DbContext
    {
        public StudYchetEntities()
            : base("name=StudYchetEntities")
        {
        }
        ...
        public virtual DbSet<Sost_Poseshaem> Sost_Poseshaem { get; set; }
